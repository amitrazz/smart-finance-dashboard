...
import { LayoutDashboard, Target, Wallet, Lightbulb, FileBarChart, ChevronRight, Home } from "lucide-react";

export type PlanningSection = "overview" | "goals" | "budgets" | "insights" | "reports";
