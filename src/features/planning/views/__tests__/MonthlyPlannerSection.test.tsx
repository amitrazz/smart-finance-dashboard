...
function buildPlan(overrides: Partial<MonthlyFinancialPlan> = {}): MonthlyFinancialPlan {
  return {
    ...
    income: { planned: money("100000"), actual: money("95000"), variance: money("-5000"), remaining: money("5000"), utilizationPercent: 95, sources: [] },
    fixedCommitments: { planned: money("20000"), actual: money("18000"), items: [] },
    debtCommitments: {
      principal: money("0"),
      interest: money("0"),
      fees: money("0"),
    ...
    budget: { allocated: money("30000"), actual: money("22000"), budgets: [] },
