...
const RAW_PLAN = {
  ...
  income: { planned: "100000", actual: "95000", variance: "-5000", remaining: "5000", utilizationPercent: "95", sources: [] },
  fixedCommitments: { planned: "20000", actual: "18000", items: [] },
  debtCommitments: {
    principal: "5000",
    interest: "500",
    fees: "0",
  ...
  budget: { allocated: "30000", actual: "22000", budgets: [] },
